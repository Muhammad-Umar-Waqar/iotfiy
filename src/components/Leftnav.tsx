...
//       {/* <div className="logo">IOTIFIY</div> */}
...
const Sidebar = () => {
  ...
  useEffect(() => {
    // Adding delay for labels on sidebar state change
    const labels = document.querySelectorAll(".custom-sidebar .label");
    labels.forEach((label, index) => {
      (label as HTMLElement).style.transitionDelay = `${isActive ? index * 50 : 0}ms`;
    });
  }, [isActive]);

  return (
    <div className={`custom-sidebar ${isActive ? "active" : ""}`}>
